...
(function (global) {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "hero.downloadCta": "Download free",
      "hero.ctaSecondary": "View plans",
      "hero.pricingCta": "View plans",
      ...
      "workflow.s1Title": "Open BromeoRemote",
      "workflow.step1Body": "The user opens the app and immediately sees a unique device ID and temporary session password.",
      "workflow.s1Body": "The user opens the app and immediately sees a unique device ID and temporary session password.",
      "workflow.step2Title": "Connect with ID & password",
      "workflow.s2Title": "Connect with ID & password",
      "workflow.step2Body": "The admin enters the ID and password and chooses the desired session permissions: view, control, or both.",
      "workflow.s2Body": "The admin enters the ID and password and chooses the desired session permissions: view, control, or both.",
      "workflow.step3Title": "Solve the problem",
      "workflow.s3Title": "Solve the problem",
      "workflow.step3Body": "Chat, transfer files, share the clipboard, record the screen and manage the device — all in one session.",
      "workflow.s3Body": "Chat, transfer files, share the clipboard, record the screen and manage the device — all in one session.",
      ...
      "pricing.subtitle": "Pay securely via Mollie. Your license is active immediately after payment.",
      ...
      "dangerZone.boxTitle": "Manage or cancel subscription",
      "dangerZone.boxDesc": "If you cancel your subscription, your Pro/Unlimited features will be disabled and your account will immediately revert to the Free plan.",
      "dangerZone.cancelBtn": "Cancel subscription...",
      "dangerZone.modalTitle": "⚠️ Are you sure you want to cancel?",
      "dangerZone.modalSubtitle": "Please review the consequences carefully before confirming.",
      "dangerZone.c1": "Your license (Pro / Unlimited) will be terminated immediately.",
      "dangerZone.c2": "Your account immediately reverts to the Free version (15 minutes per session limit).",
      "dangerZone.c3": "Features like unlimited session duration, multi-monitor and file transfer will be disabled.",
      "dangerZone.c4": "No further recurring monthly charges will be made via Mollie.",
      "dangerZone.confirmBtn": "Yes, cancel my subscription",
      "dangerZone.keepBtn": "No, keep my subscription",
      "cookieBanner.title": "🍪 Cookie & Privacy Settings",
      "cookieBanner.desc": "We use functional cookies for session management, security, and language selection. No third-party tracking cookies or ad trackers are used.",
      "cookieBanner.acceptAll": "Accept All",
      "cookieBanner.essentialOnly": "Essential Only",
      "cookieBanner.policyLink": "Read Cookie Policy",
    ...
    nl: {
      ...
      "hero.downloadCta": "Gratis downloaden",
      "hero.ctaSecondary": "Bekijk licenties",
      "hero.pricingCta": "Bekijk licenties",
      ...
      "workflow.s1Body": "De gebruiker opent de app en ziet direct een uniek apparaat-ID en tijdelijk sessiewachtwoord.",
      "workflow.step2Title": "Verbind met ID & wachtwoord",
      "workflow.s2Title": "Verbind met ID & wachtwoord",
      ...
      "workflow.s2Body": "De beheerder voert het ID en wachtwoord in en kiest de gewenste sessierechten: meekijken, besturen of allebei.",
      "workflow.step3Title": "Los het probleem op",
      "workflow.s3Title": "Los het probleem op",
      "workflow.step3Body": "Chat, bestanden overzetten, klembord delen, scherm opnemen en beheeracties — alles in één sessie.",
      "workflow.s3Body": "Chat, bestanden overzetten, klembord delen, scherm opnemen en beheeracties — alles in één sessie.",
      ...
      "pricing.subtitle": "Veilig betalen via Mollie. Je licentie is direct actief na betaling.",
      ...
      "dangerZone.boxTitle": "Abonnement beheren of opzeggen",
      "dangerZone.boxDesc": "Als je je abonnement opzegt, vervallen je betaalde Pro/Unlimited functies en keert je account direct terug naar het gratis abonnement.",
      "dangerZone.cancelBtn": "Abonnement opzeggen...",
      "dangerZone.modalTitle": "⚠️ Weet je zeker dat je wilt opzeggen?",
      "dangerZone.modalSubtitle": "Lees de onderstaande gevolgen zorgvuldig door voordat je bevestigt.",
      "dangerZone.c1": "Je licentie (Pro / Unlimited) wordt direct stopgezet.",
      "dangerZone.c2": "Je valt direct terug op de gratis versie (maximaal 15 minuten per sessie).",
      "dangerZone.c3": "Functies zoals onbeperkte duur, multi-monitor en bestandsoverdracht worden uitgeschakeld.",
      "dangerZone.c4": "Er worden geen verdere maandelijkse afschrijvingen meer gedaan via Mollie.",
      "dangerZone.confirmBtn": "Ja, zeg mijn abonnement op",
      "dangerZone.keepBtn": "Nee, behoud mijn abonnement",
      "cookieBanner.title": "🍪 Cookie & Privacy Instellingen",
      "cookieBanner.desc": "Wij gebruiken functionele cookies voor sessiebeheer, beveiliging en taalselectie. Er worden geen trackingcookies van derden of advertentietrackers geplaatst.",
      "cookieBanner.acceptAll": "Alles accepteren",
      "cookieBanner.essentialOnly": "Alleen noodzakelijk",
      "cookieBanner.policyLink": "Lees Cookiebeleid",
